<aside class="main-sidebar">
 ...
 <!--       <?php if(in_array('createStore', $user_permission) || in_array('updateStore', $user_permission) || in_array('viewStore', $user_permission) || in_array('deleteStore', $user_permission)): ?>
        ...
        <?php if(in_array('createUnit', $user_permission) || in_array('updateUnit', $user_permission) || in_array('viewStore', $user_permission) || in_array('deleteUnit', $user_permission)): ?>
          <li id="unitMainNav"><a href="<?php echo base_url('unit/') ?>"><i class="fa fa-files-o"></i> <span>Unit</span></a></li>
        <?php endif; ?> 


        <?php if(in_array('createStore', $user_permission) || in_array('updateStore', $user_permission) || in_array('viewStore', $user_permission) || in_array('deleteStore', $user_permission)): ?>
          <li id="storesMainNav"><a href="<?php echo base_url('warranty/') ?>"><i class="fa fa-files-o"></i> <span>Warranty</span></a></li>
        <?php endif; ?>
        ...
        <?php if(in_array('createProduct', $user_permission) || in_array('updateProduct', $user_permission) || in_array('viewProduct', $user_permission) || in_array('deleteProduct', $user_permission)): ?>
            <li class="treeview" id="customerMainNav">
              <a href="#">
                <i class="fa fa-files-o"></i>
                <span>Customer</span>
                <span class="pull-right-container">
              ...
              <ul class="treeview-menu">
                <?php if(in_array('createProduct', $user_permission)): ?>
                  <li id="createCustomerSubMenu"><a href="<?php echo base_url('customer/create') ?>"><i class="fa fa-circle-o"></i> Add Customer</a></li>
                <?php endif; ?>
                <?php if(in_array('updateProduct', $user_permission) || in_array('viewProduct', $user_permission) || in_array('deleteProduct', $user_permission)): ?>
                <li id="managCustomerSubMenu"><a href="<?php echo base_url('customer') ?>"><i class="fa fa-circle-o"></i> Manage Customer</a></li>
                <?php endif; ?>
              </ul>
            </li>
          <?php endif; ?>
          ...
          <?php if(in_array('createProduct', $user_permission) || in_array('updateProduct', $user_permission) || in_array('viewProduct', $user_permission) || in_array('deleteProduct', $user_permission)): ?>
            <li class="treeview" id="unitMainNav">
              <a href="#">
                <i class="fa fa-files-o"></i>
                <span>Unit  </span>
                <span class="pull-right-container">
              ...
              <ul class="treeview-menu">
                <?php if(in_array('createProduct', $user_permission)): ?>
                  <li id="createUnitSubMenu"><a href="<?php echo base_url('unit/create') ?>"><i class="fa fa-circle-o"></i> Add Unit</a></li>
                <?php endif; ?>
                <?php if(in_array('updateProduct', $user_permission) || in_array('viewProduct', $user_permission) || in_array('deleteProduct', $user_permission)): ?>
                <li id="manageUnitSubMenu"><a href="<?php echo base_url('unit') ?>"><i class="fa fa-circle-o"></i> Manage Unit</a></li>
                <?php endif; ?>
              </ul>
            </li>
          <?php endif; ?>
