                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
					  ...
					  <tr>
                        ...
                        <td><input type="checkbox" name="permission[]" id="permission" value="createOrderNew"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateOrderNew"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewOrderNew"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteOrderNew"></td>
                      </tr>
                      <tr>
                        <td>Report</td>
                        <td> - </td>
