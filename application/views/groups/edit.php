            ...
            <form role="form" action="<?php base_url('groups/update') ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
				  ...
				  <?php #print_r(($group_data)); print_r($serialize_permission);  ?>
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
					  ...
					  <tr>
						<td> <u>Orders New </u></td>
						<td><input type="checkbox" name="permission[]" id="permission" value="createOrderNew" <?php 
                        if($serialize_permission) {
                          if(in_array('createOrderNew', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
						<td><input type="checkbox" name="permission[]" id="permission" value="updateOrderNew" <?php 
                        if($serialize_permission) {
                          if(in_array('updateOrderNew', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewOrderNew" <?php 
                        if($serialize_permission) {
                          if(in_array('viewOrderNew', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteOrderNew" <?php 
                        if($serialize_permission) {
                          if(in_array('deleteOrderNew', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
						</td>
					  </tr>
                      ...
                      <tr>
                        <td>Bill</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createBill" <?php 
                        if($serialize_permission) {
                          if(in_array('createBill', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewBill" <?php 
                        if($serialize_permission) {
                          if(in_array('viewBill', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td> - </td>
                        <td> - </td>
