						 ...
						 <div class="form-group col-md-8">
							...
							<select class="form-control select_group2"  id="warranty_unit_id" name="warranty_unit_id">
							  <?php foreach ($warranty_units as $k => $v): ?>					
								 <option value="<?php echo $v['unit_id'] ?>" <?php  if($v['unit_id'] == $warranty_data['warranty_unit_id']){ echo 'selected="selected"' ; } ?>  class="select_group" ><?php  echo $v['unit_name'] ?></option>
							  <?php endforeach ?>
							</select >
						</div> 
						 <div class="form-group col-md-4">
							<label for="warranty_unit_sn">Serial Number</label>
							<input type="text" class="form-control" id="warranty_unit_sn" name="warranty_unit_sn" placeholder="Enter Unit Serial Number" autocomplete="off" value="<?php echo !empty($this->input->post('warranty_unit_sn')) ?:$warranty_data['warranty_unit_sn'] ?>" readonly="readonly"/>
						</div>
						 <div class="form-group col-md-4">
							<label for="warranty_expired_date">Expired Date</label>
							<input type="text" class="form-control" id="warranty_expired_date" name="warranty_expired_date" placeholder="Enter Unit Serial Number" autocomplete="off" value="<?php echo !empty($this->input->post('warranty_expired_date')) ?:$warranty_data['warranty_expired_date'] ?>" />
						 </div>
						 						 											
						 <!--<div class="form-group col-md-4 " >
							<label for="warranty_code">Warranty Code</label> -->
							<input type="hidden" class="form-control" id="warranty_code" name="warranty_code" placeholder="Enter Warranty Code" autocomplete="off" value="<?php echo !empty($this->input->post('warranty_code')) ?:$warranty_data['warranty_code'] ?>"  />
						 <!-- </div> -->
					 ...
					 <div class="callout callout-info">
						Please provide Unit Source and Customer info bellow. 
						 ...
						 <div class="form-group col-md-6 ">
							...
							<select class="form-control select_group2 select_container"  id="warranty_branch_id" name="warranty_branch_id">
								  <?php foreach ($warranty_branches as $k => $v): ?>					
									 <option value="<?php echo $v['branch_id'] ?>" <?php  if($v['branch_id'] == $warranty_data['warranty_branch_id']){ echo 'selected="selected"' ; } ?>  class="form-control" ><?php  echo $v['branch_code'] . " - " . $v['branch_name'] ?></option>
								  <?php endforeach ?>
							</select >	
						 </div>
						 ...
						 <div class="form-group col-md-4">
							...
							<input type="text" class="form-control" id="warranty_po_no" name="warranty_po_no" placeholder="Enter Purchase Number" autocomplete="off" value="<?php echo !empty($this->input->post('warranty_po_no')) ?:$warranty_data['warranty_po_no'] ?>" />
						 </div>
						 ...
						 <div class="form-group col-md-6">
							...
							<select class="form-control select_group2"  id="warranty_cust_id" name="warranty_cust_id">
								  <?php foreach ($warranty_customers as $k => $v): ?>					
									 <option value="<?php echo $v['customer_id'] ?>" <?php  if($v['customer_id'] == $warranty_data['warranty_cust_id']){ echo 'selected="selected"' ; } ?>  ><?php  echo $v['customer_num'] . " - " . $v['customer_nama'] ?></option>
								  <?php endforeach ?>
							</select >	
						 </div>
						 <div class="col-md-1"> </div>
						 <div class="form-group col-md-4">
							...
							<input type="text" class="form-control" id="warranty_so_no" name="warranty_so_no" placeholder="Enter Sales Number" autocomplete="off" value="<?php echo !empty($this->input->post('warranty_so_no')) ?:$warranty_data['warranty_so_no'] ?>" />
						 </div>
					</div>
					<div class="clearfix"> </div>
					<div class="col-md-12 bg-warning">
						...
						<div class="callout callout-warning">
						 ...
						 <div class="col-md-12">
							 <div class="form-group col-md-3">
								...
								<input type="text" class="form-control" id="warranty_delivery_date" name="warranty_delivery_date" placeholder="Delivery Date" autocomplete="off" value="<?php echo !empty($this->input->post('warranty_delivery_date')) ?:$warranty_data['warranty_delivery_date'] ?>" />
							 </div>
							 <div class="col-md-1"> </div>
							 <div class="form-group col-md-3">
								<label for="warranty_installed_date">Installed Date</label>
								<input type="text" class="form-control" id="warranty_installed_date" name="warranty_installed_date" placeholder="Installed Date" autocomplete="off" value="<?php echo !empty($this->input->post('warranty_installed_date')) ?:$warranty_data['warranty_installed_date'] ?>" />
							 </div>
							 <div class="col-md-1"> </div>
							 <div class="form-group col-md-3">
								<label for="warranty_handsover_date">Handsover Date</label>
								<input type="text" class="form-control" id="warranty_handsover_date" name="warranty_handsover_date" placeholder="Handsover Date" autocomplete="off" value="<?php echo !empty($this->input->post('warranty_handsover_date')) ?:$warranty_data['warranty_handsover_date'] ?>" />
							 </div>
						 </div>
					</div>
					 <div class="col-md-12">
						 <div class="form-group col-md-3 ">						 
						 <?php 
							$isRevoke = '<input class="icheckbox_blue " id="is_revoke" name="is_revoke" type="checkbox" '  ;
						 ...
						 <?php 
							$isActive = '<input class="icheckbox_blue " id="is_active" name="is_active" type="checkbox" '  ;
