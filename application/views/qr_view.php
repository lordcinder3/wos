...
<div>
			 ...
			 <div class="box-body">
					<div class="description-block col-md-2">
						...
						?>
							<img src="<?php echo $urlQR ;?>" alt="image?" class="img-square img-fluid float-left" width="250" height="250" />
					</div>
				</div>
				<div class="description-block col-md-2"  style="border:1px solid;">
				  	<h4 style="text-align:center;">www.rotaryana.com</h4>
						<h4 style="text-align:center;">management@rotaryana.com</h4>
				  </div>
